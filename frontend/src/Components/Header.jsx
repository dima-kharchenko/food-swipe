        ...
        <nav className="border-b-1 bg-surface-a0 border-primary-a0 fixed top-0 w-full z-50 select-none">
            <div className="px-5 flex flex-wrap items-center justify-between mx-auto h-12"> 
                ...
                <div className="flex text-white">
                    <a href="/" className="cursor-pointer"><i className="fa-solid fa-house"></i></a>
                    <p onClick={handleLogout} className="cursor-pointer ml-4"><i className="fa-solid fa-arrow-right-from-bracket"></i></p>
                </div>
            </div>
        </nav>
        </div>
