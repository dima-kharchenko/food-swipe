...
from api.views import RegisterView, LoginView, LogoutView, StatusView, ItemsView, QuizItemsView, RateItemView, StatsView, CreateStatsShareView, SharedStatsView, UpdateUserView, DeleteUserView
